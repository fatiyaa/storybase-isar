...
extension StoryQueryFilter on QueryBuilder<Story, Story, QFilterCondition> {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> storyEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> storyGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> storyLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> storyBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> storyStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> storyEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> storyContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'story',
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> storyMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'story',
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> storyIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'story',
        value: '',
  ...
  QueryBuilder<Story, Story, QAfterFilterCondition> storyIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'story',
        value: '',
...
extension StoryQuerySortBy on QueryBuilder<Story, Story, QSortBy> {
  ...
  QueryBuilder<Story, Story, QAfterSortBy> sortByStory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'story', Sort.asc);
    });
  }

  QueryBuilder<Story, Story, QAfterSortBy> sortByStoryDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension StoryQuerySortThenBy on QueryBuilder<Story, Story, QSortThenBy> {
  ...
  QueryBuilder<Story, Story, QAfterSortBy> thenByStory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'story', Sort.asc);
    });
  }

  QueryBuilder<Story, Story, QAfterSortBy> thenByStoryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'story', Sort.desc);
    });
  }
...
extension StoryQueryWhereDistinct on QueryBuilder<Story, Story, QDistinct> {
  ...
  QueryBuilder<Story, Story, QDistinct> distinctByStory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension StoryQueryProperty on QueryBuilder<Story, Story, QQueryProperty> {
  ...
  QueryBuilder<Story, String, QQueryOperations> storyProperty() {
    return QueryBuilder.apply(this, (query) {
